  ...
  return (
    <View>
      <View style={{ padding: 10 }}>
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'black', marginBottom: 10 }}>Service Name: {serviceName}</Text>
        <Text style={{ fontSize: 16, color: 'black' }}>Price: {price} VNĐ</Text>
      </View>
